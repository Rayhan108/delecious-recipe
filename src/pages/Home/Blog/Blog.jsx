...
const Blog = () => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "blog-content",
    onAfterPrint: () => toast("download success"),
  });
  return (
  <div className="gray">
   <div className="pt-3  text-end">
        <Button className="fs-5" variant="dark" onClick={handlePrint}>
          Print Pdf <FaFilePdf className="text-danger fs-4"></FaFilePdf>{" "}
        </Button>
        ...
        <div className="p-5">
          <h2 className=" fw-bold mt-3  text-center">Question Answer</h2>
          <h3 className="text-2xl font-bold text-center mt-5  mb-5">
            1.Tell us the differences between uncontrolled and controlled
            components.
          </h3>
          <p className="fs-5">
            <span className="fs-4  fw-bold">Ans</span>:{" "}
            ...
            state internally. They use a ref to access the DOM element's current
          ...
          <p className="">
            <span className="fs-4 fw-bold">Ans</span>:propTypes is used for
          ...
          <p className="">
            <span className="fs-4 fw-bold ">Ans</span>:
            <span className="text-decoration-underline  fw-bold">Node JS</span>{" "}
            <br />
            NodeJS is a framework of JavaScript which is mainly used for working
            with the backend of our application or building the backend using
            JavaScript. <br />{" "}
            <span className="text-decoration-underline fw-bold">
              Express JS
            </span>{" "}
            <br />
            Express js is a framework of node js.It provides broad features for
          ...
          <p className="">
            <span className="fs-4 fw-bold">Ans</span>:A custom hook is a special
            JavaScript function whose name starts with 'use' and can be used to
            call other hooks. <br /> It can be reused easily, which makes the
            ...
            code.Thats why we use custon hook.
          </p>
        </div>
      </div>
